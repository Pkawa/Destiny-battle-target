...
function RegisterAchievementTriggers()
    ...
    do
        ...
        TriggerRegisterAnyUnitEventBJ(t, EVENT_PLAYER_UNIT_SPELL_CAST)
        TriggerAddCondition(t, Condition(function()
            return GetSpellAbilityId() == ABIL.SmallFolkHeal
        end))
        TriggerAddAction(t, function()
            if GetUnitTypeId(GetSpellTargetUnit()) ~= UID.ClericSmallFolk
    ...
    do
        ...
        TriggerRegisterAnyUnitEventBJ(t, EVENT_PLAYER_UNIT_SPELL_CAST)
        TriggerAddCondition(t, Condition(function()
            return GetSpellAbilityId() == ABIL.ChakraBurst
        end))
        TriggerAddAction(t, function()
    ...
    do
        ...
        TriggerRegisterAnyUnitEventBJ(t, EVENT_PLAYER_UNIT_SPELL_CAST)
        TriggerAddCondition(t, Condition(function()
            return GetSpellAbilityId() == ABIL.FlurryOfBlows
        end))
        TriggerAddAction(t, function()
    ...
    do
        ...
        TriggerRegisterAnyUnitEventBJ(t, EVENT_PLAYER_UNIT_DEATH)
        TriggerAddCondition(t, Condition(function()
            return GetUnitTypeId(GetKillingUnitBJ()) == UID.RogueOfTheDark
    ...
    do
        ...
        TriggerRegisterAnyUnitEventBJ(t, EVENT_PLAYER_UNIT_DEATH)
        TriggerAddCondition(t, Condition(function()
            return GetUnitTypeId(GetKillingUnitBJ()) == UID.FeralArchon
    ...
    do
        ...
        TriggerAddCondition(t, Condition(function()
            ...
            local gEng = GetUnitsOfPlayerAndTypeId(p, UID.HumanEngineer)
    ...
    do
        ...
        TriggerAddCondition(t, Condition(function()
            ...
            return GetUnitTypeId(killer) == UID.SunSoulInitiate
    ...
    do
        ...
        TriggerAddAction(t, function()
            if DecimateCount > 49 then
                ...
                local g = GetUnitsOfTypeIdAll(UID.AxeBrother)
    ...
    do
        ...
        TriggerAddCondition(t, Condition(function()
            local p = GetOwningPlayer(GetConstructingStructure())
            local gCD = GetUnitsOfTypeIdAll(UID.CentaurDruid)
    ...
    do
        ...
        TriggerAddCondition(t, Condition(function()
            local killer = GetKillingUnitBJ()
            local dying = GetDyingUnit()
            return GetUnitTypeId(killer) == UID.RecklessPyromancer
                and IsUnitType(dying, UNIT_TYPE_HERO)
                and GetOwningPlayer(dying) ~= Player(9)
                and GetOwningPlayer(dying) ~= GetOwningPlayer(killer)
        end))
    ...
    do
        ...
        TriggerRegisterAnyUnitEventBJ(t, EVENT_PLAYER_UNIT_DEATH)
        TriggerAddCondition(t, Condition(function()
            return GetUnitTypeId(GetDyingUnit()) == UID.ElvenSharpshooter
                and IsUnitType(GetDyingUnit(), UNIT_TYPE_HERO)
        end))
        TriggerAddAction(t, function()
    ...
    do
        ...
        TriggerAddCondition(t, Condition(function()
            ...
            local gSS = GetUnitsOfTypeIdAll(UID.ElvenSharpshooter)
    ...
    do
        ...
        TriggerRegisterAnyUnitEventBJ(t, EVENT_PLAYER_UNIT_DEATH)
        TriggerAddCondition(t, Condition(function()
            return GetUnitTypeId(GetDyingUnit()) == UID.SquireCaptive
        end))
        TriggerAddAction(t, function()
