...
function InitHeroPool_T10()
    ...
    HeroPicked[0]  = UID.ClericSmallFolk  -- Nils, Cleric of the Small Folk
    HeroPicked[1]  = UID.ClericOfOrder  -- Infinitivus, Cleric of Order
    HeroPicked[2]  = UID.HumanEngineer  -- Mustadio, Human Engineer
    HeroPicked[3]  = UID.MasterOfTheArt  -- Arathil, Master of the Art
    HeroPicked[4]  = UID.ManAtArms  -- Boyd Axer, Man-at-Arms
    HeroPicked[5]  = UID.PaladinOfJustice  -- Haniel, Paladin of Justice  (swapped with 6)
    HeroPicked[6]  = UID.EarthenTemplar  -- Bouldergravel, Earthen Templar (swapped with 5)
    HeroPicked[7]  = UID.DwarvenAxeMaster  -- Vorthin Smashfist, Dwarven Axemaster
    HeroPicked[8]  = UID.FeralArchon  -- Newten Will'o, Feral Archon
    HeroPicked[9]  = UID.MonkEbonyFist  -- Venille Quickstrike, Monk
    HeroPicked[10] = UID.RogueOfTheDark  -- Scratch the Knife, Rogue of the Dark
    HeroPicked[11] = UID.SunSoulInitiate  -- Paladeus Sparkflame, Sun Soul Initiate
    HeroPicked[12] = UID.DwarvenRockfighter  -- Tordek Hammercrafter, Dwarven Rockfighter
    HeroPicked[13] = UID.DiscipleOfGrace  -- Faiya Hopecraft, Disciple of Grace
    HeroPicked[14] = UID.ArcaneArcher  -- Azrae, Arcane Archer
    HeroPicked[15] = UID.AxeBrother  -- Faxanadu Skullcrush, Axe Brother
    HeroPicked[16] = UID.CentaurDruid  -- Eldrad Leafrunner, Centaur Druid
    HeroPicked[17] = UID.ClericElvenWord  -- Lyrra Wyndhaar, Cleric of Elven Word
    HeroPicked[18] = UID.CrestedDrake  -- Scorchmaw, Crested Drake
    HeroPicked[19] = UID.HalfElvenBard  -- Melody Starsong, Half-Elven Bard
    HeroPicked[20] = UID.ElvenSharpshooter  -- Amy Fletcher, Elven Sharpshooter
    HeroPicked[21] = UID.RecklessPyromancer  -- Majin Flarefire, Reckless Pyromancer
    HeroPicked[22] = UID.WildernessRunner  -- Leylana Woodwillow, Wilderness Runner
    HeroPicked[23] = UID.WarGuard  -- Karl Ironstance, War Guard
    HeroPicked[24] = UID.HorizonWanderer  -- Eros Farltravel, Horizon Wanderer
    HeroPicked[25] = UID.TundraBarbarian  -- Truhbold Wolfheart, Tundra Barbarian
    HeroPicked[26] = UID.Swashbuckler  -- Dramlor Mal'chazzen, Rogue
    HeroPicked[27] = UID.Illusionist  -- Cyril Everglow, Gnome Illusionist
    HeroPicked[28] = UID.Wildbond  -- Lilithia Primalfang, Wildbond
    HeroPicked[29] = UID.FireMagus  -- Krellen Wythel, Fire Magus
    HeroPicked[30] = UID.ElvenCryptguard  -- Faye the Forgotten, Elven Cryptguard
    HeroPicked[31] = UID.BorderSkirmisher  -- Tomi Wittaker, Border Skirmisher
    HeroPicked[32] = UID.DwarvenTrueborn  -- Khelgar the First, Dwarven Trueborn
